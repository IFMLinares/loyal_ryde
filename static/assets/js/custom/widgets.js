    ...
    !(function () {
      ...
      [].slice.call(t).map(function (e) {
        ...
        if (e) {
          ...
          new ApexCharts(e, {
            series: [{ name: "Beneficio neto", data: [30, 45, 32, 70, 40] }],
            chart: {
              fontFamily: "inherit",
              type: "area",
              height: t,
      ...
      (function () {
        ...
        [].slice.call(e).map(function (e) {
          ...
          if (e) {
            ...
            new ApexCharts(e, {
              series: [
                { name: "Beneficio neto", data: [40, 40, 30, 30, 35, 35, 50] },
              ],
              chart: {
                fontFamily: "inherit",
                type: "area",
      ...
      a &&
        new ApexCharts(a, {
          series: [
            { name: "Beneficio neto", data: [44, 55, 57, 56, 61, 58] },
            { name: "Ganancia", data: [76, 85, 101, 98, 87, 105] },
          ],
          chart: {
            fontFamily: "inherit",
            type: "bar",
      ...
      (function () {
        ...
        e &&
          new ApexCharts(e, {
            series: [
              { name: "Beneficio neto", data: [30, 40, 40, 90, 90, 70, 70] },
            ],
            chart: {
              fontFamily: "inherit",
              type: "area",
      ...
      (function () {
        ...
        e &&
          new ApexCharts(e, {
            series: [
              { name: "Beneficio neto", data: [60, 50, 80, 40, 100, 60] },
              { name: "Ganancia", data: [70, 60, 110, 40, 50, 70] },
            ],
            chart: {
              fontFamily: "inherit",
              type: "area",
      ...
      (function () {
        ...
        e &&
          new ApexCharts(e, {
            series: [
              { name: "Beneficio neto", data: [40, 50, 65, 70, 50, 30] },
              { name: "Ganancia", data: [-30, -40, -55, -60, -40, -20] },
            ],
            chart: {
              fontFamily: "inherit",
              type: "bar",
      ...
      (function () {
        ...
        e &&
          new ApexCharts(e, {
            series: [
              { name: "Beneficio neto", data: [30, 30, 50, 50, 35, 35] },
              { name: "Ganancia", data: [55, 20, 20, 20, 70, 70] },
      ...
      (function () {
        ...
        [].slice.call(o).map(function (o) {
          (a = parseInt(KTUtil.css(o, "height"))),
            ...
            new ApexCharts(o, {
              series: [
                { name: "Beneficio neto", data: [30, 45, 32, 70, 40, 40, 40] },
              ],
              chart: {
                fontFamily: "inherit",
                type: "area",
      ...
      (function () {
        ...
        [].slice.call(e).map(function (e) {
          ...
          if (e) {
            ...
            new ApexCharts(e, {
              series: [{ name: "Beneficio neto", data: [30, 25, 45, 30, 55, 55] }],
              chart: {
                fontFamily: "inherit",
                type: "area",
                height: t,
        ...
        [].slice.call(e).map(function (e) {
          ...
          if (e) {
            var a = e.getAttribute("data-kt-chart-color"),
              ...
              i = KTUtil.getCssVariableValue("--bs-light-" + a);
            new ApexCharts(e, {
              series: [{ name: "Beneficio neto", data: [30, 30, 60, 25, 25, 40] }],
              chart: {
                fontFamily: "inherit",
                type: "area",
                height: t,
        ...
        [].slice.call(e).map(function (e) {
          ...
          if (e) {
            var a = e.getAttribute("data-kt-chart-color"),
              ...
              i = KTUtil.getCssVariableValue("--bs-light-" + a);
            new ApexCharts(e, {
              series: [{ name: "Beneficio neto", data: [15, 25, 15, 40, 20, 50] }],
              chart: {
                fontFamily: "inherit",
                type: "area",
                height: t,
      ...
      (function () {
        ...
        [].slice.call(o).map(function (o) {
          (e = o.getAttribute("data-kt-color")),
            ...
            new ApexCharts(o, {
              series: [
                { name: "Beneficio neto", data: [50, 60, 70, 80, 60, 50, 70, 60] },
                { name: "Ganancia", data: [50, 60, 70, 80, 60, 50, 70, 60] },
              ],
              chart: {
                fontFamily: "inherit",
                type: "bar",
      ...
      (function () {
        ...
        [].slice.call(t).map(function (t) {
          (e = parseInt(KTUtil.css(t, "height"))),
            new ApexCharts(t, {
              series: [
                { name: "Beneficio neto", data: [35, 65, 75, 55, 45, 60, 55] },
                { name: "Ganancia", data: [40, 70, 80, 60, 50, 65, 60] },
              ],
              chart: {
                fontFamily: "inherit",
                type: "bar",
...
>>>>>>> 47476af6971150b28798dd9e020ac2f9ff87d4d9
